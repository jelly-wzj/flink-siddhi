...
public class StreamSchema<T> implements Serializable {
     ...
     * @param fieldNames
     */
    public StreamSchema(TypeInformation<T> typeInfo, TypeInformation[] fieldTypes, String... fieldNames) {
        Preconditions.checkNotNull(fieldNames, "Field name is required");
        Preconditions.checkNotNull(fieldTypes, "Field types is required");
        this.typeInfo = typeInfo;
        this.fieldNames = fieldNames;
        this.fieldIndexes = getFieldIndexes(typeInfo, fieldNames);
